...
while extensions_number != '1' and extensions_number != '2':                              extensions_number = input(f"Расширение компонентов: \n\n1. tsx\n2. jsx\n(Номер): ")
frameworks_number = input("\n\nФреймворк: \n\n1. react\n2. react-native\n(Номер): ")

while frameworks_number != '1' and frameworks_number != '2':              frameworks_number = input(f"\n\nФреймворк: \n\n1. react\n2. react-native\n(Номер): ")

with open('config.py', 'w') as f:
    f.write(f"os = '{os[os_number]}'\nlanguage = '{languages[language_number]}'\nextension = '{extensions[extensions_number]}'\nframework = '{frameworks[frameworks_number]}'")
